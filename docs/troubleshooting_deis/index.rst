...
``deisctl refresh-units --tag=v1.13.4``, or set the ``$DEISCTL_UNITS`` environment variable to a directory
...
.. _`open an issue`: https://github.com/deisthree/deis/issues/new
